...
export default function LoginPage() {
  ...
  return (
    <Container className="min-h-screen flex items-center justify-center py-12 px-4">
      ...
      >
        <Card className="w-full max-w-md hover-lift reveal-animation">
          <CardHeader className="space-y-1 text-center">
            ...
            >
              <CardTitle className="text-2xl font-serif tracking-tight text-foreground animated-gradient-text">
