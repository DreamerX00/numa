...
async function performAuthFlowTest(email: string) {
...
export async function GET() {
  try {
    console.log('🔍 Testing complete auth flow (GET request)...');
    
    // Test with default values for GET request
    const email = "test@example.com";
    
    return await performAuthFlowTest(email);
  } catch (error) {
