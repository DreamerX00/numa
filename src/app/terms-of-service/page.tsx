...
export const metadata: Metadata = {
  ...
  description:
    "Read our terms of service for shopping at Numa. Understand your rights, obligations, and our policies for jewelry purchases.",
  openGraph: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-20 left-10 w-80 h-80 bg-indigo-400/30 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "5s" }}
        />
        <div
          className="absolute top-60 right-10 w-96 h-96 bg-purple-400/30 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "7s", animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-40 left-1/4 w-72 h-72 bg-pink-400/30 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "6s", animationDelay: "2s" }}
        />
        <div
          className="absolute top-1/3 right-1/3 w-64 h-64 bg-fuchsia-400/20 rounded-full blur-3xl animate-pulse"
        ...
        <Container className="relative py-24 md:py-36">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <Star
                className="w-8 h-8 text-amber-300 animate-spin fill-amber-300"
            ...
            <p className="text-2xl md:text-3xl text-white/95 max-w-3xl mx-auto leading-relaxed font-light mb-10">
              Your trust matters to us. These terms ensure a fair, transparent,
              and secure shopping experience for all our valued customers.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-16 p-10 rounded-3xl bg-gradient-to-br from-white via-indigo-50/80 to-purple-50/80 backdrop-blur-xl border-2 border-indigo-300 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-indigo-700 to-purple-600 bg-clip-text text-transparent">
                Quick Navigation
              </h2>
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                return (
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${item.color} opacity-0 group-hover/item:opacity-100 transition-opacity duration-300`}
                    />
                ...
                <div className="relative space-y-6 pl-8">
                  <div className="p-6 rounded-2xl bg-white/70 backdrop-blur-sm border border-blue-200 shadow-md">
                    <p className="text-gray-700 text-lg leading-relaxed mb-4">
                      ...
                      access to and use of the Numa website, mobile
                      applications, and related services. By creating an
                      account, placing an order, or otherwise using our
                      Services, you agree to comply with these Terms.
                    </p>
                    <p className="text-gray-700 text-lg leading-relaxed mb-4">
                      If you do not agree to these Terms, you may not access or
                      use our Services. We reserve the right to modify these
                      Terms at any time, and your continued use of the Services
                    ...
                    <div className="mt-4 p-4 rounded-xl bg-amber-50 border-2 border-amber-300">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-amber-900 font-semibold">
                          ...
                          18 years old to use our Services and make purchases.
                          By using Numa, you represent that you meet this age
                          requirement.
                        </p>
                      </div>
                    </div>
                ...
                <div className="relative flex items-start gap-6 mb-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-purple-700 leading-relaxed text-xl font-medium">
                      Information about our jewelry products and ordering
                      process.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="p-6 rounded-2xl bg-white/70 backdrop-blur-sm border border-purple-200 shadow-md">
                    ...
                    <ul className="space-y-3 text-gray-700 text-lg">
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          All jewelry items are described and photographed as
                      ...
                      <li className="flex items-start gap-3">
                        <span className="w-2 h-2 rounded-full bg-gradient-to-r from-purple-500 to-fuchsia-500 mt-2.5 flex-shrink-0" />
                        <span>
                          Custom or personalized items may have extended
                          processing times
                        </span>
                      </li>
                    </ul>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-2xl bg-white/70 backdrop-blur-sm border border-purple-200 shadow-md hover:shadow-lg transition-shadow">
                      ...
                      <p className="text-gray-700">
                        ...
                        We&apos;ll notify you if we cannot fulfill your order.
                      </p>
                    </div>
                    ...
                    <div className="p-6 rounded-2xl bg-white/70 backdrop-blur-sm border border-purple-200 shadow-md hover:shadow-lg transition-shadow">
                      ...
                      <p className="text-gray-700">
                        ...
                        Custom items cannot be cancelled once production begins.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative space-y-6 pl-8">
                  <div className="p-6 rounded-2xl bg-white/70 backdrop-blur-sm border border-green-200 shadow-md">
                    ...
                    <ul className="space-y-3 text-gray-700 text-lg">
                      ...
                      <li className="flex items-start gap-3">
                        <span className="w-2 h-2 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 mt-2.5 flex-shrink-0" />
                        <span>
                          Shipping charges and taxes added at checkout
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        desc: "Available on select orders",
                        icon: "💵",
                      ...
                      <div
                        key={item.title}
                        className={`p-6 rounded-2xl bg-white/70 backdrop-blur-sm border border-green-200 shadow-md hover:shadow-xl hover:scale-105 transition-all`}
                      >
                        <div
                          className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${item.gradient} shadow-md mb-4 text-2xl`}
                        >
                          {item.icon}
                        </div>
                  ...
                  <div className="p-6 rounded-2xl bg-gradient-to-r from-green-100 to-emerald-100 border-2 border-green-300">
                    <p className="text-green-900 font-semibold flex items-start gap-3">
                      ...
                      <span>
                        All payment transactions are encrypted and PCI-DSS
                        compliant. We never store your complete credit card
                        information.
                      </span>
                    </p>
                  </div>
                ...
                <div className="relative space-y-6 pl-8">
                  <div className="grid md:grid-cols-3 gap-6">
                    {[
                      ...
                      <div
                        key={item.label}
                        className={`p-6 rounded-2xl bg-white/70 backdrop-blur-sm border-2 border-${item.color}-200 shadow-md hover:shadow-xl hover:scale-105 transition-all text-center`}
                      >
                    ...
                    <ul className="space-y-3 text-gray-700 text-lg">
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          ...
                          On orders above ₹
                          {settings.shipping.freeShippingThreshold} within India
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="w-2 h-2 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 mt-2.5 flex-shrink-0" />
                        <span>
                          <strong className="text-amber-700">Tracking:</strong>{" "}
                          Receive tracking info once your order ships
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="w-2 h-2 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 mt-2.5 flex-shrink-0" />
                        <span>
                          ...
                          7-14 business days (select countries)
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="p-6 rounded-2xl bg-gradient-to-r from-amber-100 to-orange-100 border-2 border-amber-300">
                    <p className="text-amber-900 font-semibold flex items-start gap-3">
                      ...
                      <span>
                        Delivery times are estimates. We&apos;re not responsible
                        for courier delays. Ensure someone is available to
                        receive packages.
                      </span>
                    </p>
                  </div>
                ...
                <div className="relative space-y-6 pl-8">
                  ...
                  <div className="p-6 rounded-2xl bg-white/70 backdrop-blur-sm border border-rose-200 shadow-md">
                    ...
                    <div className="grid md:grid-cols-4 gap-4">
                      {[
                        ...
                        <div
                          key={item.step}
                          className="text-center p-4 rounded-xl bg-rose-50 border border-rose-200"
                        >
                  ...
                  <div className="p-6 rounded-2xl bg-gradient-to-r from-green-100 to-emerald-100 border-2 border-green-300">
                    <p className="text-green-900 font-bold text-lg flex items-start gap-3">
                      <ShieldCheck className="w-6 h-6 flex-shrink-0 mt-1" />
                      <span>
                        100% Authentic Guarantee: If you receive a counterfeit
                        item, we&apos;ll provide a full refund and cover all
                ...
                <div className="relative grid md:grid-cols-3 gap-6">
                  <div className="p-8 rounded-2xl bg-white/80 backdrop-blur-sm border border-violet-200 shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <a
                      ...
                      className="text-lg font-bold text-violet-600 hover:text-violet-500"
                    >
